...
- [Local market-data pipeline operations](local-market-data-pipeline.md) — start, verify, monitor, restart, stop, and validate the Coinbase-to-MinIO pipeline.
- [Podman machine connection recovery](podman-machine-connection-recovery.md) — recover a stale Windows/WSL Podman socket without deleting the VM or project data.
