...
`audit_raw_market_trades.py` is a bounded batch entry point. It captures fixed
broker beginning/end offsets for every current partition before comparing that
